...
//macaco = anda,pelo, cabeca, braco
//homem = anda, cabeca, braco
train({
	input: ['anda', 'anda', 'pelo', 'cabeca', 'cabeca'],
	output: ['macaco', 'homem', 'macaco', 'macaco','homem']
});

let catacteristicas = ['anda','fala','pelo']
console.log(predict('fala'));
